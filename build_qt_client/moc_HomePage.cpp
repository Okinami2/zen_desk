...
#include <memory>
#include "../qt_client/src/pages/HomePage.h"
...
QT_MOC_LITERAL(1, 9, 19), // "enterStudyRequested"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 10) // "updateTime"

    },
    "HomePage\0enterStudyRequested\0\0updateTime"
};
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enterStudyRequested(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomePage::enterStudyRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HomePage::enterStudyRequested()
{
